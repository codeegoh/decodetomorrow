...
namespace DigiMap {
	...
	public class GOTileObj {
		...
		public DigiMap.GOMap.GOMapType mapType;
...
//		public GORoadNetwork roadNetwork;
		...
		public GOTileObj (Vector2 tileCoordinates, int zoomLevel, DigiMap.GOMap.GOMapType mapType, bool useElevation, float elevationMultiplier, Vector2 resolution,
		...
		public static GOElevationAPI MapTypeToElevationType (DigiMap.GOMap.GOMapType mapType) {
