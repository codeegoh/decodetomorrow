...
namespace DigiShared{
	...
	public static class MapboxLayerExtensions  {
		...
		public static GOFeatureType GOFeatureType(this VectorTileFeature feature, List<List<LatLng>> geomWgs84) {
			...
			GOFeatureType type = DigiShared.GOFeatureType.Undefined;

			if (geomWgs84.Count > 1) {
				switch (feature.GeometryType) {
				case GeomType.POINT:
					type = DigiShared.GOFeatureType.MultiPoint;
					break;
				case GeomType.LINESTRING:
					type =DigiShared. GOFeatureType.MultiLine;
					break;
				case GeomType.POLYGON:
					type = DigiShared.GOFeatureType.MultiPolygon;
					break;
				default:
					break;
				}
				...
				switch (feature.GeometryType) {
				case GeomType.POINT:
					type = DigiShared.GOFeatureType.Point;
					break;
				case GeomType.LINESTRING:
					type = DigiShared.GOFeatureType.Line;
					break;
				case GeomType.POLYGON:
					type = DigiShared.GOFeatureType.Polygon;
					break;
				default:
					break;
				}
