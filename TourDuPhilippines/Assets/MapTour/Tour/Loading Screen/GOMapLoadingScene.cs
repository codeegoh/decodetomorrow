...
namespace DigiMap
{
    public class GOMapLoadingScene : MonoBehaviour
    {
        ...
        GOTile createSmartTileObject(Vector2 tileCoords, int Zoom)
        {
            ...
            GOTileObj goTile = new GOTileObj(tileCoords, locationManager.zoomLevel, (DigiMap.GOMap.GOMapType)mapType, useElevation, 1, new Vector2(50, 50), useCache, false, locationManager.worldScale, useSatelliteBackground, satellite4X, false, navmeshSettings);
